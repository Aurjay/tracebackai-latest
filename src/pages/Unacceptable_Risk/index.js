...
const UnacceptableRiskPage = styled.div`
  width: 80%;
  max-width: 500px;
  padding: 1rem;
  text-align: center;
...
const UnacceptableRisk = () => {
  const [answers, setAnswers] = useState(Array(5).fill('')); // Initialize with 5 empty strings

  const questions = [
    {
      question: ' Unacceptable Risk  Project Details 1',
      options: ['Option A', 'Option B', 'Option C'],
    },
    {
      question: 'Unacceptable Risk Project Details 2',
...
export default UnacceptableRisk;
